...
export function IconsList() {
  return (
    <div className="fixed bottom-0 right-4 flex flex-col gap-4 after:m-auto after:w-[2px] after:rounded-sm after:h-16 dark:after:bg-neutral-500 after:bg-neutral-900">
      {data.map((s) => (
        <IconButton
          key={s.name}
          name={s.name}
